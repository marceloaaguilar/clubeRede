  ...
  const buscaEmpresas = async () => {
    await setListaEmpresas(
      [  
        ...
        { id: 4, nome: "Loja Seculus", categoria: "moda", logo: "/logoSeculos.png", palavrasChave: "loja de relógios, relojoaria, seculus", cupom: 'REDE50', linkCupom: "https://seculusoutletday.com.br" },
        ...
        { id: 79, nome: "Integral Médica", categoria: "saude", logo: "/logoIntegralMedica.png", palavrasChave: "suplementos, Integral Médica", cupom:"CLUBE", linkCupom: 'https://www.integralmedica.com.br'},
        { id: 80, nome: "Pizzaria Spoleto", categoria: "gastronomia", logo: "/logoPizzariaSpoleto.png", palavrasChave: "pizzaria, Spoleto, restaurante", cupom:"CLUBEPIZZA", linkCupom: 'https://www.pizzariaspoleto.com.br/tabs/cardapio', benefits: '50% desconto compras acima de 30,00 pedidos através do Site', conditions: 'Limitado a 1 uso por CPF.Não cumulativo com outras promoções.Válido somente para unidade Copacabana/RJ.'},
        { id: 81, nome: "Aldeia das Águas", categoria: "viagem", logo: "/logoAldeiaDasAguas.png", palavrasChave: "resort, Aldeia das águas, viagem, pousada", link: "http://loja.multiclubes.com.br/aldeia/Ingressos/ingressogrupo?Promoter=anQ0VFc5cHhEakdESXBHeEZLUjBpUT09" },
        { id: 82, nome: "Nutrify", categoria: "saude", link: "https://www.nutrify.com.br/", logo: "/logoNutrify.png", palavrasChave: "nutrição, suplementos, saúde" },
        ...
        { id: 84, nome: "Água de Cheiro", categoria: "moda", linkCupom: "https://www.aguadecheiro.com.br/", cupom: "REDE15", benefits: "15% OFF em todo site.", logo: "/logoAguadeCheiro.png", palavrasChave: "perfume, fragrâncias, beleza, agua de cheiro" },
        ...
        { id: 86, nome: "University RD Station", categoria: "educacao",  link: "https://university.rdstation.com/", cupom: "Não é necessário inserir cupom de desconto.", benefits: "100% OFF em cursos do site", logo: "/logoRdUniversity.png", palavrasChave: "cursos, marketing digital, educação, rd university" },
        { id: 87, nome: "Fundação Bradesco", link: "https://www.ev.org.br/", cupom: "Não é necessário inserir cupom de desconto.", benefits: "100% OFF em cursos do site", logo: "/logoFundacaoBradesco.png", categoria: "Educação", palavrasChave: "educação, cursos online, gratuito, fundação bradesco" },
        ...
        { id: 90, nome: "LG", categoria: "ecommerce", linkCupom: "https://lg.parceriasonline.com.br/clube-da-rede-veiculos", cupom: "PARCEIROLG5/PARCEIROLG10/PARCEIROLG15", benefits: "Até 18% OFF em produtos LG", conditions: "Cupom cumulativo com cupom de primeira compra. Adquira mais descontos através do pagamento no PIX. Não cumulativo com outras promoções vigentes no site LG; Válido apenas para (Audio & Video + Refrigeradores, Micro-ondas, Lava e Seca + Ar Condicionado). *Demais regras no rodapé. Produtos com até 5% de desconto + até 8% off pagando à vista via PIX ou em até 12x sem juros no cartão de crédito. Frete grátis por tempo indeterminado. Entrega disponível para regiões Sul, Sudeste, Capitais do Centro Oeste, Recife e Salvador. Consulte seu CEP. Para a região de São Paulo e Grande SP poderemos oferecer instalação grátis. Consulte regulamento válido no site. Não cumulativo.", validade: "Válido até 13/10 ou enquanto durarem os estoques", logo: "/logoLG.png", palavrasChave: "eletrônicos, tecnologia, eletrodomésticos" },
        { id: 91, nome: "FGV", categoria: "educacao", link: "https://educacao-executiva.fgv.br/cursos/gratuitos", benefits: "100% OFF em cursos do site", logo: "/logoFGV.png",  palavrasChave: "educação, cursos online, gratuito, fgv" },
        { id: 92, nome: "Nacional Inn", categoria: "viagem", linkCupom: "https://www.nacionalinn.com.br/", benefits: "20% de desconto nas hospedagens.", conditions: "Necessário realizar a reserva pelo e-mail vvendas@hoteisnacionalinn.com ou pela central de reserva segunda a sexta 09:00 as 17:00hs 11-96060-2592 procurar pela gerente Stella e informar ser Associado Rede Veículos para obter os descontos." ,logo: "/logoNacionalInn.png",  palavrasChave: "hotel, viagens, hospedagem, viagem, nacional inn" },
        { id: 93, nome: "RDC Viagens", categoria: "viagem" , link: "https://rdcviagens.com.br/", logo: "/logoRDCViagens.png", palavrasChave: "viagens, pacotes, turismo, viagem, pousada" },
        { id: 94, nome: "Zion Semi Joias", categoria: "moda", linkCupom: "https://zionsemijoias.com.br/", cupom: "REDE15", benefits: '15% de desconto necessário usar cupom no carrinho', logo: "/logoZionSemiJoias.png",  palavrasChave: "semijoias, joias, acessórios, zion" },
        ...
        { id: 98, nome: "English Work", categoria: "educacao", linkCupom: "https://englishwork.com.br/", cupom: "EWCLUBEREDE", benefits: "58% OFF no curso de inglês", logo: "/logoEnglishWork.png",  palavrasChave: "inglês, cursos, idiomas" },
        { id: 99, nome: "Le Postiche", categoria: "moda", linkCupom: "https://lepostiche.parceriasonline.com.br/clube-da-rede-veiculos", cupom: "proxymedia5/proxymedia10", benefits: "5% OFF/10% OFF na 1ª compra", conditions: "Não cumulativo com demais cupons promocionais", logo: "/logoLePostiche.png", palavrasChave: "bolsas, mochilas, malas" },
        { id: 100, nome: "Sebrae", categoria: "educacao", linkCupom: "https://sebrae.com.br/sites/PortalSebrae/cursosonline", cupom: "Não é necessário inserir cupom de desconto", logo: "/logoSebrae.png", palavrasChave: "empreendedorismo, cursos, online, sebrae" },
        { id: 101, nome: "Madesa", categoria: "ecommerce", linkCupom: "https://www.madesa.com/", cupom: "CLUBEREDE", benefits: "7% OFF em todo o site, exceto montagem", logo: "/logoMadesa.png",  palavrasChave: "móveis, decoração, casa" },
