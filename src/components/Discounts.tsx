  ...
  const buscaEmpresas = async () => {
    await setListaEmpresas(
      [
        ...
        { id: 81, nome: "Aldeia das Águas", categoria: "Resorts", logo: "/logoAldeiaDasAguas.png", palavrasChave: "resort, Aldeia das águas, viagem, pousada", link: "http://loja.multiclubes.com.br/aldeia/Ingressos/ingressogrupo?Promoter=anQ0VFc5cHhEakdESXBHeEZLUjBpUT09" },
