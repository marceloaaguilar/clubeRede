  ...
  const buscaEmpresas = () => {
    setListaEmpresas(
      [  
        ...
        { id: 118, nome: "Orlando America", categoria: "automotivo,viagem",  cupom:"REDE20 ", linkCupom: "https://www.orlandoamericarentalcar.com/", benefits:"20% no valor total da fatura", conditions: "Informar na hora da reserva no WhatsApp o código REDE20 para garantir o benefício." , logo: "/orlandoAmerica.png", palavrasChave: "orlando, aluguel" },
        { id: 119, nome: "New Time Tour", categoria: "viagem",  cupom:"REDE10 ", linkCupom: "https://www.newtimetour.com.br", benefits:"10% de desconto nos pacotes de viagem", conditions: "Necessário incluir cupom de desconto REDE10 na página de pagamentos. Desconto será aplicado sobre o valor total." , logo: "/logoNewTimeTour.jpeg", palavrasChave: "new time tour, aluguel" },
        { id: 120, nome: "Decolar", categoria: "viagem",  benefits:"Hospedagem: Com R$100 OFF nas reservas a partir de R$2500 <br>Pacotes: Com R$200 OFF nas reservas a partir de R$2500 <br>Aluguel de carros: R$50 OFF <br>Seguros: 20% OFF <br> Transfers: 5% OFF", link: "https://decolar.parceriasonline.com.br/clube-da-rede-veiculos", conditions: "Necessário incluir cupom de desconto REDE10 na página de pagamentos. Desconto será aplicado sobre o valor total." , logo: "/logoDecolar.png", palavrasChave: "viagens, decolar" }
      ]
    )
  }
