  ...
  const buscaEmpresas = async () => {
    await setListaEmpresas(
      [  
        ...
        { id: 93, nome: "RDC Viagens", categoria: "viagem" , linkCupom: "https://rdc-viagens.parceriasonline.com.br/clube-da-rede-veiculos", logo: "/logoRDCViagens.png", palavrasChave: "viagens, pacotes, turismo, viagem, pousada, rdc, RDC viagens", conditions: "Link já esta com desconto não sendo necessário utilizar cupom."},
        ...
        { id: 106, nome: "Meta", categoria: "educacao", linkCupom: "https://pt-br.facebook.com/business/learn/courses", cupom: "Não é necessário inserir cupom de desconto", conditions: "Carteirinha de estudante a 25,00. Necessário fazer a solicitação pelo link da parceria.",  benefits: "100% OFF em cursos do site", logo: "/logoMeta.png", palavrasChave: "cursos, facebook, marketing digital, meta" },
        { id: 107, nome: "UVA", categoria: "educacao" , linkCupom: "https://graduacao.uva.br/extensao/?_ga=2.47309991.1428931641.1678403130-1781876364.1678403130", logo: "/logoUVA.png",  conditions: "Carteirinha de estudante a 25,00. Necessário fazer a solicitação pelo link da parceria.",  palavrasChave: "educação, cursos online, graduação, uva" },
        { id: 108, nome: "Cruzeiro do Sul", categoria: "educacao", linkCupom: "https://www.cruzeirodosulvirtual.com.br/", benefits: "100% OFF em cursos online", logo: "/logoCruzeiroDoSul.png", palavrasChave: "universidade, cursos, graduação cruzeiro do sol", conditions: "Carteirinha de estudante a 25,00. Necessário fazer a solicitação pelo link da parceria." },
        { id: 109, nome: "Fesn", categoria: "educacao", linkCupom: "https://vendas.alcaia.net/mariananevesdigital", benefits: "100% OFF em cursos online", logo: "/logoFESN.png", palavrasChave: "Educação, Cursos, Online, Fesn, fesn", conditions: "Carteirinha de estudante a 25,00. Necessário fazer a solicitação pelo link da parceria." },
