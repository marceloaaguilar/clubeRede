  ...
  const buscaEmpresas = async () => {
    await setListaEmpresas(
      [  
        ...
        { id: 108, nome: "Cruzeiro do Sul", categoria: "educacao", linkCupom: "https://www.cruzeirodosulvirtual.com.br/", benefits: "100% OFF em cursos online", logo: "/logoCruzeiroDoSul.png", palavrasChave: "universidade, cursos, graduação cruzeiro do sol", conditions: "Não é necessário cupom, link da parceria já libera cursos gratuitos." },
